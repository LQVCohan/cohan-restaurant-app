...
export function sanitizeAuthUser(user) {
  ...
  return pickDefined({
    ...
    verificationLastChannel: source.verificationLastChannel,
    verificationLastStatus: source.verificationLastStatus,
    verificationLastRequestedAt: source.verificationLastRequestedAt,
    emailVerifyLastSentAt: source.emailVerifyLastSentAt,
    phoneVerifyLastSentAt: source.phoneVerifyLastSentAt,
