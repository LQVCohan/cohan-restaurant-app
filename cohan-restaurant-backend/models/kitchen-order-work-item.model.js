...
const KitchenOrderWorkItemSchema = new Schema(
  {
    ...
    cancelledAt: Date,
    returnedAt: Date,
    issueType: { type: String, enum: ["void", "return", null], default: null, index: true },
    issueReason: String,
    issueReasonCategory: { type: String, enum: ["kitchen_quality", "kitchen_delay", "kitchen_wrong_item", "kitchen_unavailable", "service_order_mistake", "customer_request", "payment_or_bill", "unknown", null], default: null, index: true },
    issueReasonKitchenRelated: { type: Boolean, default: false, index: true },
    issueReasonMatchedKeyword: String,
    issueReviewNote: String,
    issueRefundMode: String,
