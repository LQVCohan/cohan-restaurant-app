...
- Không hiển thị KPI tổng bảng lương nhỏ hơn 0; phiếu âm hoặc khấu trừ vượt thu nhập phải được đánh dấu để rà soát.
...
3. KPI tổng bảng lương không hiển thị số âm; từng phiếu âm hoặc có khấu trừ vượt thu nhập vẫn hiện rõ trong cảnh báo và chi tiết dòng.
4. Chọn "Tạm tính theo khoảng ngày" khiến query không gửi `periodId`; sửa ngày tự chuyển sang chế độ này.
5. Chọn một kỳ chính thức đồng bộ khoảng ngày hiển thị theo kỳ; sau đó sửa ngày sẽ chuyển sang tạm tính thay vì giả vờ lọc snapshot.
