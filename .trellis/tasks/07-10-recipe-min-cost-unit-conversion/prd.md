...
- Khu vực danh sách công thức còn trộn tiếng Anh và tiếng Việt ở các nhãn như `Min Cost`, `Variants`, `recipe` và `cost`.
...
- Việt hóa các nhãn trực tiếp liên quan đến công thức, biến thể và giá vốn trong danh sách công thức.
...
- Không còn các nhãn `Min Cost`, `Variants`, `Chưa có recipe` và `Thiếu cost` trên thẻ công thức.
