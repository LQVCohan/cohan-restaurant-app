...
- `src/context/__tests__/AuthProvider.test.jsx`: verify logout navigates before clearing the Apollo account cache.
...
- `npx vitest run src/context/__tests__/AuthProvider.test.jsx src/context/__tests__/AuthProvider.login-race.test.jsx`
