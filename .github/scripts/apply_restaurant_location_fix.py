...
backend = "cohan-restaurant-backend/graphql/resolvers/restaurant/mutation.js"
...
for helper in (
    ".github/workflows/restaurant-location-production-autofix.yml",
    ".github/workflows/restaurant-location-production-pr.yml",
    ".github/workflows/apply-restaurant-location-fix.yml",
    ".github/scripts/apply_restaurant_location_fix.py",
):
