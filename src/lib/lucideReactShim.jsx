...
export const {
  ...
  ClipboardList, ClipboardPaste, Clock, Clock3, CloudUpload, Coffee, Coins, Columns3, Combine, Compass, CookingPot, Copy,
  CreditCard, Crown, CupSoda, Database, DollarSign, Dot, Download, Droplet, Droplets, Edit, Edit2, Edit3, Ellipsis,
  EllipsisVertical, Eraser, ExternalLink, Eye, EyeOff, Facebook, File, FileClock, FileDown, FileImage, FilePlus2,
  FileSpreadsheet, FileText, FileUp, Filter, FilterX, Fish, Flag, Flame, Flashlight, FlashlightOff, FolderPlus, Gauge,
  Gift, Grid, Grid2X2, Grid3X3, GripVertical, Hand, HandCoins, HardDrive, Hash, Headphones, Heart, HelpCircle, History,
  Home, IdCard, Image, ImageOff, ImagePlus, Inbox, Info, Instagram, Key, KeyRound, Languages, Layers, Layers3, Layout,
