...
export const {
  ...
  Scale, ScanLine, Scissors, Search, SearchX, Send, Server, ServerCog, Settings, Settings2, Share2, Shield, ShieldAlert,
  ...
  TicketPercent, Timer, Trash, Trash2, TrendingDown, TrendingUp, TriangleAlert, Truck, Twitter, Type, Undo2, Unlock, Upload,
