...
const iconNames = [
  "Accessibility", "Activity", "AlarmClock", "AlertCircle", "AlertOctagon", "AlertTriangle", "Archive", "ArrowDown", "ArrowDownRight", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowUpRight", "BadgeCheck", "Ban", "Banknote", "BarChart", "BarChart2", "BarChart3", "Beef", "Bell", "BellOff", "BookOpen", "Bot", "Box", "Boxes", "Briefcase", "Building", "Building2", "Calculator", "Calendar", "CalendarCheck", "CalendarCheck2", "CalendarClock", "CalendarDays", "CalendarRange", "Camera", "CameraOff", "Carrot", "ChartNoAxesColumnIncreasing", "Check", "CheckCheck", "CheckCircle", "CheckCircle2", "ChefHat", "ChevronDown", "ChevronLeft", "ChevronRight", "ChevronUp", "ChevronsUpDown", "Circle", "CircleCheck", "CircleDollarSign", "CircleHelp", "CirclePause", "CirclePlay", "CirclePlus", "Clipboard", "ClipboardCheck", "ClipboardList", "Clock", "Clock3", "CloudUpload", "Coffee", "Coins", "Columns3", "Copy", "CreditCard", "Crown", "Database", "DollarSign", "Dot", "Download", "Edit", "Edit2", "Edit3", "Ellipsis", "EllipsisVertical", "ExternalLink", "Eye", "EyeOff", "File", "FileDown", "FileImage", "FilePlus2", "FileSpreadsheet", "FileText", "FileUp", "Filter", "FilterX", "Fish", "Flame", "Flag", "Gauge", "Gift", "Grid", "Grid2X2", "Grid3X3", "GripVertical", "Hash", "Headphones", "Heart", "HelpCircle", "Home", "Image", "ImagePlus", "Inbox", "Info", "Key", "KeyRound", "Languages", "Layers", "LayoutGrid", "Leaf", "Link", "List", "ListFilter", "Loader", "Loader2", "LocateFixed", "Lock", "LockKeyhole", "LogOut", "Mail", "Map", "MapPin", "MapPinned", "Maximize2", "Megaphone", "Menu", "MessageCircle", "MessageSquare", "Minimize2", "Minus", "Monitor", "Moon", "MoreHorizontal", "MoreVertical", "Move", "MoveDown", "MoveLeft", "MoveRight", "MoveUp", "Navigation", "Package", "PackageOpen", "PackageSearch", "PanelLeftClose", "PanelLeftOpen", "Paperclip", "PartyPopper", "Pause", "PauseCircle", "Percent", "Phone", "PieChart", "Pin", "Pizza", "Play", "PlayCircle", "Plus", "Printer", "QrCode", "Receipt", "RefreshCcw", "RefreshCw", "RotateCcw", "RotateCw", "Save", "ScanLine", "Search", "SearchX", "Send", "Settings", "Shield", "ShieldAlert", "ShieldCheck", "ShoppingBag", "ShoppingCart", "SlidersHorizontal", "Smartphone", "Smile", "Soup", "Sparkle", "Sparkles", "SquarePen", "Star", "Store", "Sun", "Sunrise", "SwitchCamera", "Table", "Table2", "Tag", "Tags", "Ticket", "Timer", "Trash", "Trash2", "TrendingDown", "TrendingUp", "Truck", "Undo2", "Unlock", "Upload", "User", "UserCheck", "UserCog", "UserMinus", "UserPlus", "UserRound", "UserX", "Users", "Utensils", "UtensilsCrossed", "Video", "Wallet", "Warehouse", "Wifi", "Wine", "X", "XCircle", "Zap", "ZoomIn", "ZoomOut",
];
...
export const {
  ...
  FileUp, Filter, FilterX, Fish, Flame, Flag, Gauge, Gift, Grid, Grid2X2, Grid3X3, GripVertical, Hash, Headphones,
  Heart, HelpCircle, Home, Image, ImagePlus, Inbox, Info, Key, KeyRound, Languages, Layers, LayoutGrid, Leaf, Link,
  ...
  Settings, Shield, ShieldAlert, ShieldCheck, ShoppingBag, ShoppingCart, SlidersHorizontal, Smartphone, Smile, Soup,
  ...
  UserRound, UserX, Users, Utensils, UtensilsCrossed, Video, Wallet, Warehouse, Wifi, Wine, X, XCircle, Zap, ZoomIn, ZoomOut,
} = iconMap;
