...
export const {
  ...
  IdCard, Image, ImageIcon, ImageOff, ImagePlus, Inbox, Info, Instagram, Key, KeyRound, Languages, Layers, Layers3, Layout,
  ...
  Scale, ScanLine, Scissors, Search, SearchCheck, SearchX, Send, Server, Settings, Settings2, Share2, Shield, ShieldAlert,
