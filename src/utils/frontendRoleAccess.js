...
export const MENU_MANAGEMENT_ACTIONS = {
  ...
  MANAGE_MENU_GROUP: "menu.group.manage",
  MANAGE_GROUP: "menu.group.manage",
  MANAGE_MODIFIER: "menu.modifier.manage",
...
const MENU_ACTION_PERMISSION_MAP = {
  ...
  [MENU_MANAGEMENT_ACTIONS.MANAGE_MODIFIER]: ["menu.modifier.manage", "menu.write"],
