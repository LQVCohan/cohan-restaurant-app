...
export const PrivateRoute = ({
  ...
  const waitingForResolvedUser =
    Boolean(token) && (role == null || !isAuthenticated);
    ...
    return (
      <div className="min-h-[40vh] w-full flex flex-col items-center justify-center px-4 text-center">
        <p className="text-sm font-medium text-amber-700">
          {sessionWarning ||
            "Mạng không ổn định. Đang chờ xác minh phiên đăng nhập..."}
        </p>
      </div>
    );
  }
  ...
  if (
    !hasAllowedRole(allowedRoles, role) ||
...
const AccountScopedRedirect = ({ basePath }) => {
  ...
  return userId ? (
    <Navigate to={`${basePath}/${userId}`} replace />
  ) : (
...
const AppRouter = () => (
  <Routes>
    ...
    <Route
      ...
      element={<VerifyAccountConfirm forcedChannel="SMS" />}
    />
    ...
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<StaffDashboardPage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
    ...
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<ReservationChangeReviewPage />),
        STAFF_ORDER_ROLES,
      )}
    />
    <Route
      path="/staff/kitchen"
      element={withPrivateRoute(
        withStaffLayout(<StaffKitchenPage />),
        STAFF_KITCHEN_ROLES,
      )}
    />
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<StaffPerformancePage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/schedule"
      element={withPrivateRoute(
        withStaffLayout(<StaffSchedulePage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<StaffAttendancePage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/leave"
      element={withPrivateRoute(
        withStaffLayout(<StaffLeavePage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/profile"
      element={withPrivateRoute(
        withStaffLayout(<StaffProfilePage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<StaffNotificationsPage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/contacts"
      element={withPrivateRoute(
        withStaffLayout(<StaffCommunicationPage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      ...
      element={withPrivateRoute(
        withStaffLayout(<AiHandoffInbox />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/payslips"
      element={withPrivateRoute(
        withStaffLayout(<StaffPayslipsPage />),
        STAFF_SHARED_ROLES,
      )}
    />
    <Route
      path="/staff/settings"
      element={withPrivateRoute(
        withStaffLayout(<StaffSettingsPage />),
        STAFF_SHARED_ROLES,
      )}
    />
    ...
    <Route
      ...
      element={withPrivateRoute(
        ...
        ["manager", "admin", "hr", "accountant"],
      )}
    />
    <Route
      path="/manager/dashboard/POS"
      element={withPrivateRoute(withLazyRoute(<POSLayout />), [
        "manager",
        "admin",
      ])}
    />
    ...
    />
    <Route
      path="/manager/reservation-changes"
      element={withPrivateRoute(
        <ManagerLayout>
    ...
    <Route
      ...
      element={withPrivateRoute(<Dashboard />, ["admin"])}
    />

    <Route
      path="/users"
      element={withPrivateRoute(
        <Navigate to="/manager#rbac" replace />,
        ["admin"],
      )}
    />
    <Route
      path="/settings"
      element={withPrivateRoute(
        <Navigate to="/manager#settings" replace />,
        ["admin"],
      )}
    />
    <Route
    ...
    <Route
      path="/inventory"
      element={withPrivateRoute(
        <Navigate to="/manager#inventory" replace />,
        ["admin", "manager"],
      )}
    />
    <Route
    ...
    <Route
      path="/promotions"
      element={withPrivateRoute(
        <Navigate to="/manager#promotions" replace />,
        ["admin", "manager"],
      )}
    />
    <Route
    ...
    <Route element={<CustomerLayout />}>
      ...
      <Route
        path="/owner/:id"
        element={withPrivateRoute(<OwnerProfilePage />, ["manager", "admin"])}
      />
      <Route
        path="/for-you"
        element={withPrivateRoute(<ForYou />, ["customer"])}
      />
      <Route path="/cart" element={<CartPage />} />
      <Route
        path="/wallet"
        element={withPrivateRoute(<WalletPage />, ["customer"])}
      />
      <Route
        path="/orders"
        element={withPrivateRoute(<OrdersPage />, [
          "customer",
          "manager",
          "admin",
        ])}
      ...
      <Route
        ...
        element={withPrivateRoute(<OrderTrackingPage />, [
          "customer",
          "manager",
          "admin",
        ])}
      ...
      <Route
        path="/coupons"
        element={withPrivateRoute(<CouponPage />, [
          "customer",
          "manager",
          "admin",
        ])}
      ...
      <Route
        path="/favorites"
        element={withPrivateRoute(
          <AccountScopedRedirect basePath="/favorites" />,
          ["customer", "manager", "admin"],
        )}
      />
      <Route
        path="/favorites/:id"
        element={withPrivateRoute(<FavoritePage />, [
          "customer",
          "manager",
          "admin",
        ])}
      ...
      <Route
        path="/address-book"
        element={withPrivateRoute(
          <AccountScopedRedirect basePath="/address-book" />,
          ["customer", "manager", "admin"],
        )}
      />
      <Route
        path="/address-book/:id"
        element={withPrivateRoute(<AddressPage />, [
          "customer",
          "manager",
          "admin",
        ])}
      ...
      <Route
        path="/help-center"
        element={withPrivateRoute(
          <AccountScopedRedirect basePath="/help-center" />,
          ["customer", "manager", "admin"],
          false,
        )}
      />
      ...
      <Route
        path="/notifications"
        element={withPrivateRoute(<StaffAwareNotificationsRoute />, [
          "customer",
          "admin",
          "manager",
          ...STAFF_OPERATIONAL_ROLES,
      ...
      <Route
        path="/profile"
        element={withPrivateRoute(<StaffAwareProfileRoute />, [
          "customer",
          "admin",
          "manager",
          ...STAFF_OPERATIONAL_ROLES,
