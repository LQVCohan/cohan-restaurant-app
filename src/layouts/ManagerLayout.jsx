...
const PAGE_CONFIG = {
  ...
  "customer-analytics": { title: "Phân tích khách hàng", description: "Phân tích nhóm khách, món phổ biến và mức độ gắn bó", icon: "📈", keywords: ["analytics", "phân tích", "khách", "insight"] },
