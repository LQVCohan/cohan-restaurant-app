...
export default function CartBottomSheet({
  ...
  const permissions = useMemo(() => {
    ...
    return {
      canCreateOrder: isRemoteOrder ? elevated : elevated || server,
      canRequestPayment: elevated || server || cashier,
      canRemindItems: elevated || server,
      canAdjustItemQuantity: elevated || server,
      canRequestItemVoid: elevated || server,
      isReadOnlyRole: role === "host" || role === "cashier",
    };
  }, [isRemoteOrder, role]);
