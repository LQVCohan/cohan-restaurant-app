            ...
            {loadingShifts ? (
              ...
              <div className="staff-shift-list">
                {shifts.map((shift) => {
                  ...
                  const declineReason = declineDraft[shift.id]?.reason || "";
                  const isDeclineReasonTooShort = declineReason.trim().length < 5;
