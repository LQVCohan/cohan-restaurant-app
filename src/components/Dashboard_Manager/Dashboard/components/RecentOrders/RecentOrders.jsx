...
const STATUS_LABEL = {
  pending: "Chờ xử lý", confirmed: "Chờ xử lý", customer_attached: "Chờ xử lý",
  preparing: "Đang chuẩn bị", ready: "Đang chuẩn bị", served: "Đang chuẩn bị",
  ...
  return (
    <div className={shellClass}>
      <div className="order-list-body custom-scrollbar">
        ...
        {!loading && safeOrders.length === 0 ? <div className="empty-state"><div className="empty-icon"><ShoppingBag size={28} /></div><p>Chưa có đơn hàng trong khoảng thời gian này.</p></div> : null}
