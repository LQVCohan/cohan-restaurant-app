...
export const normalizeVisualConfigForClient = (visualConfig) => {
  ...
  return {
    ...
    aiJobId: trimString(visualConfig.aiJobId || visualConfig.jobId, 160),
    aiProvider: trimString(visualConfig.aiProvider || visualConfig.provider, 120),
    generationStatus: trimString(visualConfig.generationStatus, 80),
    placement,
