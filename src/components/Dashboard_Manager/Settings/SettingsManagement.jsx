...
const SettingsManagement = () => {
  ...
  return (<div className="settings-management"><header className="settings-management__hero"><div><h2>Cài đặt hệ thống</h2><p>Quản lý cấu hình vận hành, bảo mật, phân quyền và các thiết lập liên quan đến nhà hàng.</p></div><div className="settings-management__badges" aria-label="Trạng thái trang"><span>Backend foundation</span><span>Đọc cấu hình</span><span>Chỉnh sửa ở PR sau</span></div></header>
