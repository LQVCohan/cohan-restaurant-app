  ...
  const validateStep = (step) => {
    ...
    if (step === 1) {
      ...
      if (!formData.roleSlug) {
        ...
        newErrors.roleSlug = "Danh sách vai trò chưa tải xong. Vui lòng thử lại sau vài giây.";
      } else if (!selectedRoleRecord) {
        newErrors.roleSlug = "Vai trò đã chọn chưa được cấu hình trong hệ thống. Vui lòng seed roles hoặc chọn vai trò khác.";
      }
