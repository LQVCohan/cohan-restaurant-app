    ...
    <section className="ai-admin-page ai-admin-page--settings">
      ...
      >
        ...
        <article>
          ...
          <small>
            {thresholdValue.toFixed(2)} = {thresholdPercent}% ngưỡng chuyển hỗ
            trợ
          </small>
        </article>
        <article>
        ...
        <article className="ai-admin-panel ai-admin-panel--main">
          <header className="ai-admin-panel__header">
            <div>
              ...
              <p>
                Giữ giọng nói rõ ràng, thân thiện và tránh câu quá dài vì khách
                thường đọc nhanh trên điện thoại.
              </p>
            </div>
            <div className="ai-admin-actions ai-admin-actions--settings">
              <button
                type="submit"
                disabled={saving || loading || !effectiveRestaurantId}
              >
                {saving ? "Đang lưu..." : "Lưu"}
              </button>
              <button
          ...
          <div className="ai-admin-form ai-admin-form--settings">
            ...
            <label className="ai-admin-field">
              ...
              <small className="ai-admin-help">
                Khi lưu, hệ thống sẽ trim từng dòng và bỏ qua dòng rỗng.
              </small>
            </label>
          ...
          <div className="ai-admin-form">
            ...
            <label className="ai-admin-field">
              ...
              <input
                ...
                onChange={(event) =>
                  updateForm({
                    lowConfidenceHandoffThreshold: Number(event.target.value),
                  })
                }
              />
              <small className="ai-admin-help">
